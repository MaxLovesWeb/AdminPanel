                                ...
                                <div class="tab-pane text-left fade show active" id="tabs-permission" role="tabpanel" aria-labelledby="tabs-permission-tab">
                                    <div class="card-body">
                                        ...
                                        <div class="btn-toolbar justify-content-between" role="group">
                                            <a class="btn btn-outline-primary" role="button" href="{{ route('permissions.edit', $permission) }}" type="button">Edit</a>
                                            <a class="btn btn-outline-primary" role="button" href="{{ route('permissions.destroy', $permission) }}" type="button">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
