<div class="btn-group" role="group">
	@can('view', $address)
	    <a class="btn btn-outline-primary" href="{{ route('addresses.show', $address) }}" data-toggle="tooltip" title="{!! __('template::buttons.show') !!}">
	    	<i class="fa fa-eye"></i>
		</a>
	@endcan

	@can('update', $address)
	    <a class="btn btn-outline-success" href="{{ route('addresses.edit', $address) }}" data-toggle="tooltip" title="{!! __('template::buttons.edit') !!}">
